            ...
            >
              ...
              <div className="mb-4 space-y-1 ">
                <button
                  ...
                  className="w-full text-start px-3 py-2 rounded-lg text-lg text-gray-200 bg-white/10 hover:bg-white/20"
                >
                  ➕ New Notes
                </button>
                <hr className="border-white/10 mb-4" />

                <h2 className="mb-4 text-lg font-bold bg-linear-to-br from-white via-gray-300 to-white bg-clip-text text-transparent">
                  📚 Your Notes
                </h2>
