  ...
  shadow-[0_25px_60px_rgba(0,0,0,0.7)]"
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        >
          ...
          >
            ...
            <span
              className="text-lg  font-semibold from-white via-gray-300 to-white bg-clip-text text-white"
              style={{ textShadow: "0 6px 18px rgba(0,0,0,0.4 )" }}
            >
              NotesGenix <span className="text-gray-400">AI</span>
            </span>
          </div>
          <p className="text-sm text-gray-300 max-w-sm">
            NotesGenix AI helps students generate exam-focused notes, revision
      ...
      <p className="text-center text-xs text-gray-500">
        © {new Date().getFullYear()} NotesGenix AI. All rights reserved.
      </p>
    </motion.div>
  );
};
